...
Protocol=HTTP,LoadBalancerPort=80,InstanceProtocol=HTTP,InstancePort=80 --subnets subnet-cb246bbd
 ...
 aws elb create-load-balancer --load-balancer-name dmartihawk --listeners Protocol=HTTP,LoadBalancerPort=80,InstanceProtocol=HTTP,InstancePort=80 --availability-zone us-west-2b dmartihawk-1323102667.us-west-2.elb.amazonaws.com
